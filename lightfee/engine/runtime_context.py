...
class EntryDispatchRuntimeContext(RuntimeCommonContext, Protocol):
    ...
    def _entry_effective_readiness_provider_name(self, *args: Any, **kwargs: Any) -> Any: ...

    def _entry_effective_readiness_provider_uses_quote_lease(self, *args: Any, **kwargs: Any) -> Any: ...

    def _entry_local_l2_effective_enabled(self, *args: Any, **kwargs: Any) -> Any: ...
