...
class EntryDispatchRuntimeContext(RuntimeCommonContext, Protocol):
    ...
    def _entry_l2_owned_ready_books(self, *args: Any, **kwargs: Any) -> Any: ...

    def _post_only_maker_l2_guard(self, *args: Any, **kwargs: Any) -> Any: ...
...
class PassiveMakerRuntimeContext(RuntimeCommonContext, Protocol):
    ...
    def _pending_entry_l2_ready_books(self, pending: Any, now_ms: int) -> Any: ...
