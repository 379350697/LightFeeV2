...
def test_current_state_pending_close_owner_is_visible_and_blocks_green_health():
    state = {
        "lifecycle": "running",
        "risk_mode": "running",
        "last_tick_ms": 1778786999000,
    ...
    assert report.details["pending_close_count"] == 0
    assert report.details["pending_passive_close_count"] == 1
