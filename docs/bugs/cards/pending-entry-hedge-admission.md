...
| 2026-06-21 | `ESPORTSUSDT` unopened Aster admission-blocked quantity plan plus terminal-flat quantity warning residues | `cfd0644`, deployed baseline `32c5017`, residual diagnostic root fix in this changeset | cloud baseline flat/no-open-orders and no exact `-5022`/`-2022`; residual RED/GREEN keeps unproven active mismatches warning while terminal-flat accounting-gap adjustments resolve | [daily/2026-06-21.md#cluster-cl-105---latest-deploy-2-7-root-fix-semantic-closure](../daily/2026-06-21.md#cluster-cl-105---latest-deploy-2-7-root-fix-semantic-closure) |
