...
| 2026-06-04 | `SEIUSDT` Bybit/Hyperliquid | working tree; cloud deploy pending | local RED/GREEN fixed retained rejected positive-fill recovery: startup no longer stays `risk_only`, normal reconciliation no longer repeats `reconciliation.rejected_pending_retained_with_fill`, matched quantity `68.0` opens, and Bybit excess `387.0` queues residual repair | [daily/2026-06-04.md#cluster-cl-048-post-deploy-seiusdt-pending-entry-live-truth-mismatch](../daily/2026-06-04.md#cluster-cl-048-post-deploy-seiusdt-pending-entry-live-truth-mismatch) |
