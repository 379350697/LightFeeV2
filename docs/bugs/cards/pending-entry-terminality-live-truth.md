...
| 2026-06-04 | `SEIUSDT` Bybit/Hyperliquid open maker order | working tree | local RED/GREEN prevents zero-fill finalization when Bybit live open-order truth still has the maker order; production deploy/acceptance pending, and any pre-existing orphan order still requires explicit operator-approved cleanup if it remains | [daily/2026-06-04.md#cluster-cl-049-post-cl048-seiusdt-open-maker-order-terminality](../daily/2026-06-04.md#cluster-cl-049-post-cl048-seiusdt-open-maker-order-terminality) |
