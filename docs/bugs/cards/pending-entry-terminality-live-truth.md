...
| 2026-06-24 | Bitget passive cancel contract family params | local target green; deploy pending | CL-114 keeps `owned_pending_entry_live_conflict` as the correct blocker but fixes the owner cleanup transport path: Bitget passive cancel now resolves Classic vs UTA account family and sends the family-required `productType/marginCoin` or `category` fields. This is a venue-contract drift, not a relaxation of pending-entry terminality or live-truth gates. See [daily/2026-06-24.md#cluster-cl-114---bitget-passive-cancel-contract-family-params](../daily/2026-06-24.md#cluster-cl-114---bitget-passive-cancel-contract-family-params). |
