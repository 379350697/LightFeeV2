# Bug Index Historical Closure Archive (2026-05-15 to 2026-06-18)

This archive preserves long-form `Latest ...` closure narratives that used to
live in `docs/bugs/BUG_INDEX.md`. Keep full incident evidence in daily ledgers;
this file exists only to keep old index prose searchable without letting the
current router grow unbounded.
