...
event appears in WS BBO effective mode. Focused local verification passed
(`125 passed` for the heartbeat suite and `555 passed` for the WS BBO/Local-L2
follow-up suite), compileall and diff-check passed, and GitNexus detect-changes
