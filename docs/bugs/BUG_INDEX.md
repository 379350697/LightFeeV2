...
through the local-state/state-consistency/acceptance-gate views.
Focused local verification passed (`125 passed` for the heartbeat suite,
`555 passed` for the WS BBO/Local-L2 follow-up suite, and `156 passed` for the
