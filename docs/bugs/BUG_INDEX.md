...
|---|---|---|---|---|
| 2026-06-20 | CL-103 | passive-close final truth single-leg cleanup; risk-only/fail-closed non-terminal exposure | local green; deploy pending | [daily](daily/2026-06-20.md#cluster-cl-103---passive-close-final-truth-single-leg-cleanup-contract), [card](cards/passive-close-terminal-flatness.md) |
