...
|---|---|---|---|---|
| 2026-06-21 | CL-105 | latest deploy 2-7 semantic closure; quick-flat samples and entry timestamp contract; entry quantity unopened/terminal-flat adjustments; close accounting terminal truth; lifecycle payload mapping; Binance close `-5022`/`-2022` | `7e7e23f` deployed/cloud verified; gate green, exchange flat/no-open-orders | [daily](daily/2026-06-21.md#cluster-cl-105---latest-deploy-2-7-root-fix-semantic-closure), [passive close card](cards/passive-close-terminal-flatness.md), [market-data card](cards/market-data-snapshot-freshness.md), [admission card](cards/pending-entry-hedge-admission.md) |
