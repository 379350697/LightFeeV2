...
| 2026-06-23 | CL-108 | entry OI admission action taxonomy; confirmed below-floor vs unavailable OI evidence | local green; diagnostic taxonomy only; no entry/close threshold or trading-guard changes | [daily](daily/2026-06-23.md#cluster-cl-108---entry-oi-admission-action-taxonomy-closure), [market-data card](cards/market-data-snapshot-freshness.md) |
