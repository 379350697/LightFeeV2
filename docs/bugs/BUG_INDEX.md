...
|---|---|---|---|---|
| 2026-06-19 | CL-102 | centralized business contract; entry sizing residual evidence; reconciliation evidence gap; admission aggregation counters | local implementation in progress | [daily](daily/2026-06-19.md#cluster-cl-102---business-contract-centralization-and-process-issue-counters), [passive close card](cards/passive-close-terminal-flatness.md), [admission card](cards/pending-entry-hedge-admission.md) |
